...
\title{Karakteristike dobrog predavanja\\ \small{Seminarski rad u okviru kursa\\Metodologija stručnog i naučnog rada\\ Matematički fakultet}}

\author{Luka Stanković, Simona Jevtović, Relja Pešić, Milica Kužet\\ kontakt email prvog, drugog, trećeg člana, mi241054@alas.matf.bg.ac.rs}
...
\section{Uvod}
\label{sec:uvod}
Kvalitet predavanja predstavlja jednu od ključnih elemenata u obrazovnom procesu, imaju centralnu ulogu u prenošenju znanja i razvijanju veština studenata. U ovom radu istražujemo šta čini jedno predavanje dobrim, oslanjajući se upravo na mišljenja samih studenata, u ovom slučaju sa Matematičkog fakulteta. Za potrebe izrade seminarskog rada sprovedena je anketa na osnovu koje je cilj bio saznati mišljenje o tome koje karakteristike predavanja se smatraju najvažnijim za bolje razumevanje, praćenje i motivaciju tokom učenja. 
U nastavku rada detaljno ćemo razmotriti rezultate ankete i definisati ključne karakteristike koje po mišljenju studenata jedno predavanje čine boljim. Njeni rezultati će pružiti uvid u to šta ispitanici misle da se dodatno može unaprediti kako bi nastava bila efikasnija i korisnija.
